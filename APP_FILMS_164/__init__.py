...
try:
    ...
    app.secret_key = SECRET_KEY_FLASK  # Utilisez la clé secrète de l'environnement
    csrf = CSRFProtect(app)  # Initialisez CSRFProtect
    ...
    from APP_FILMS_164.habitat import gestion_habitat_crud
    from APP_FILMS_164.habitat import gestion_habitat_wtf_forms

    from APP_FILMS_164.exigences_de_croissance import gestion_exigences_de_croissance_crud
    from APP_FILMS_164.exigences_de_croissance import gestion_exigences_de_croissance_wtf_forms

    from APP_FILMS_164.utillisation import gestion_utillisation_crud
    from APP_FILMS_164.utillisation import gestion_utillisation_wtf_forms
